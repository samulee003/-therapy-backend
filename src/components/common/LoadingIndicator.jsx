...
import { Box, CircularProgress, Typography, LinearProgress, Backdrop, Paper } from '@mui/material';
...
const LoadingIndicator = ({
  ...
  const renderLoader = () => {
    switch (type) {
      ...
      case 'overlay':
        return (
          <Backdrop open={true} sx={{ zIndex: theme => theme.zIndex.drawer + 1, ...sx }} {...props}>
            <Paper
              elevation={3}
              sx={{
                p: 3,
      ...
      case 'inline':
        return (
          <Box
            ...
            {...props}
          >
            <CircularProgress size={sizeMap.small} sx={{ mr: message ? 1 : 0 }} />
            {message && (
